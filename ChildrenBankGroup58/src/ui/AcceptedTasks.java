...
public class AcceptedTasks extends JFrame{
    ...
    public AcceptedTasks(){//创造AcceptedTasks实例
        ...
        try {
            ...
            // 创建下方区域面板（返回TBParent界面）
            JPanel lowerPanel = new JPanel();
            lowerPanel.setOpaque(false);//面板透明
            lowerPanel.setPreferredSize(new Dimension(getWidth(),30));
            lowerPanel.setLayout(new GridBagLayout());
            GridBagConstraints gbclow = new GridBagConstraints();
            
            // 创建button
            JButton backButton = new JButton("Back to Parents' View");
